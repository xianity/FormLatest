...
if(isset($_POST['submit'])){
    ...
    $body3 = $_POST["body3"];
    $body4 = $_POST["body4"];
    $result = mysqli_query($conn, "UPDATE gwaform SET contentedit1 = '$body1', contentedit2 = '$body2', contentedit3 = '$body3', forname = '$body4'");
    header("Location:gwareqedit.php");
}
